...
pathD = 'D:\PycharmProjects\FCMNet-main\results\Deraindrop\';
img_denoise_list = dir(strcat(pathD,'*.png'));

% Noise image path (end with '\'):  
pathN = 'D:\NCHU\Dataset\Deraindrop\test_a_samesize\data\';
img_noise_list = dir(strcat(pathN,'*.png'));

% Clean image path (end with '\'): 
pathGT = 'D:\NCHU\Dataset\Deraindrop\test_a_samesize\gt\';
